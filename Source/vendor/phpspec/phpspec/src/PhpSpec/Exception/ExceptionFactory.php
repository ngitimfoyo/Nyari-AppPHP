...
class ExceptionFactory {
	...
	public function namedConstructorNotFound($classname, $method, array $arguments = array()) {
		...
		return new Fracture\NamedConstructorNotFoundException ( $message, $subject, $method, $arguments );
	}
	...
	public function methodNotFound($classname, $method, array $arguments = array()) {
		...
		return new Fracture\MethodNotFoundException ( $message, $subject, $method, $arguments );
	}
	...
	public function callingMethodOnNonObject($method) {
		return new SubjectException ( sprintf ( 'Call to a member function %s on a non-object.', $this->presenter->presentString ( $method . '()' ) ) );
	}
	...
	public function settingPropertyOnNonObject($property) {
		return new SubjectException ( sprintf ( 'Setting property %s on a non-object.', $this->presenter->presentString ( $property ) ) );
	}
