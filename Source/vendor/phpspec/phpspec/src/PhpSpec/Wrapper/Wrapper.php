...
class Wrapper {
	 ...
	 */
	public function __construct(MatcherManager $matchers, PresenterInterface $presenter, EventDispatcherInterface $dispatcher, ExampleNode $example, AccessInspectorInterface $accessInspector = null) {
	...
	private function createCaller(WrappedObject $wrappedObject) {
		...
		return new Caller ( $wrappedObject, $this->example, $this->dispatcher, $exceptionFactory, $this, $this->accessInspector );
	}
}
