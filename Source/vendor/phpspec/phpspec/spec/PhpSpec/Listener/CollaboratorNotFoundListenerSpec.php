...
class CollaboratorNotFoundListenerSpec extends ObjectBehavior {
	function let(IO $io, CollaboratorNotFoundException $exception, ExampleEvent $exampleEvent, ResourceManagerInterface $resources, GeneratorManager $generator, ResourceInterface $resource) {
	...
	function it_prompts_to_generate_missing_collaborator(IO $io, ExampleEvent $exampleEvent, SuiteEvent $suiteEvent) {
		$this->afterExample ( $exampleEvent );
		$this->afterSuite ( $suiteEvent );
		
		$io->askConfirmation ( 'Would you like me to generate an interface `Example\ExampleClass` for you?' )->shouldHaveBeenCalled ();
	}
	function it_does_not_prompt_to_generate_when_there_was_no_exception(IO $io, ExampleEvent $exampleEvent, SuiteEvent $suiteEvent) {
	...
	function it_generates_interface_when_prompt_is_answered_with_yes(IO $io, ExampleEvent $exampleEvent, SuiteEvent $suiteEvent, GeneratorManager $generator, ResourceInterface $resource) {
