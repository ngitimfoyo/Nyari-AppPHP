...
class DotFormatterSpec extends ObjectBehavior {
	...
	function it_outputs_a_dot_for_a_passed_example(ExampleEvent $event, IO $io, StatisticsCollector $stats) {
	...
	function it_outputs_a_p_for_a_pending_example(ExampleEvent $event, IO $io, StatisticsCollector $stats) {
	...
	function it_outputs_an_s_for_a_skipped_example(ExampleEvent $event, IO $io, StatisticsCollector $stats) {
	...
	function it_outputs_an_f_for_a_failed_example(ExampleEvent $event, IO $io, StatisticsCollector $stats) {
	...
	function it_outputs_a_b_for_a_broken_example(ExampleEvent $event, IO $io, StatisticsCollector $stats) {
	...
	function it_outputs_the_progress_every_50_examples(ExampleEvent $exampleEvent, SuiteEvent $suiteEvent, IO $io, StatisticsCollector $stats) {
