...
class JsonExecutionContextSpec extends ObjectBehavior {
	function let() {
		$this->beConstructedThrough ( 'fromEnv', array (
				array (
						'PHPSPEC_EXECUTION_CONTEXT' => '{"generated-types":[]}' 
				) 
		) );
	}
	...
	function it_can_be_serialized_as_env_array() {
		...
		$this->asEnv ()->shouldReturn ( array (
				'PHPSPEC_EXECUTION_CONTEXT' => '{"generated-types":["PhpSpec\\\\Foo"]}' 
		) );
	}
}
