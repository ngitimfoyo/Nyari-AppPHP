...
class Finder implements \IteratorAggregate, \Countable {
	 ...
	 * @return Finder The current Finder instance
	 *        
	 * @see FilenameFilterIterator @api
	 */
	 ...
	 * @return Finder The current Finder instance
	 *        
	 * @see ExcludeDirectoryFilterIterator @api
	 */
