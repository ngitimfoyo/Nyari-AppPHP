...
class ParameterBagTest extends \PHPUnit_Framework_TestCase {
	...
	public function testFilter() {
		...
		$this->assertEquals ( 'http://example.com/foo', $bag->filter ( 'url', '', false, FILTER_VALIDATE_URL, array (
		...
		$this->assertEquals ( array (
				'bang' 
		), $bag->filter ( 'array', '', false ), '->filter() gets a value of parameter as an array' );
	}
