...
class MongoDbProfilerStorage implements ProfilerStorageInterface {
	...
	public function find($ip, $url, $limit, $method, $start = null, $end = null) {
		$cursor = $this->getMongo ()->find ( $this->buildQuery ( $ip, $url, $method, $start, $end ), array (
				'_id',
				'parent',
				'ip',
				'method',
	...
	public function read($token) {
		$profile = $this->getMongo ()->findOne ( array (
				'_id' => $token,
				'data' => array (
						'$exists' => true 
				) 
	...
	public function write(Profile $profile) {
		...
		$result = $this->getMongo ()->update ( array (
				'_id' => $profile->getToken () 
	...
	protected function readChildren($token) {
		...
		$cursor = $this->getMongo ()->find ( array (
				'parent' => $token,
				'data' => array (
						'$exists' => true 
				) 
