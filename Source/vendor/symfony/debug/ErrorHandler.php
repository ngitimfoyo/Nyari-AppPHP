...
class ErrorHandler {
	 ...
	 *
	 * @param self|null|int $handler
	 *        	The handler to register, or @deprecated (since version 2.6, to be removed in 3.0) bit field of thrown levels
	 * @param bool $replace
	...
	public static function register($handler = null, $replace = true) {
		...
		if ($replace || ! $prev) {
			$handler->setExceptionHandler ( set_exception_handler ( array (
					$handler,
					'handleException' 
			) ) );
		} else {
	 ...
	 *        	The level (null to use the error_reporting() value and 0 to disable)
	 *        	
	 ...
	 *
	 * @param int $displayErrors
	 *        	The display_errors flag value
	 *        	
	 * @deprecated since version 2.6, to be removed in 3.0. Use throwAt() instead.
	 */
	 ...
	 *        	The channel associated with the logger (deprecation, emergency or scream)
	 *        	
