	...
	public function signatureReflectors() {
		return array (
				array (
						...
						"class Psy\Test\Formatter\SignatureFormatterTest " . 'extends PHPUnit_Framework_TestCase implements ' . 'PHPUnit_Framework_SelfDescribing, Countable, ' . 'PHPUnit_Framework_Test' 
				),
				array (
