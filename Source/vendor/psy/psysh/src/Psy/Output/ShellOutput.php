...
class ShellOutput extends ConsoleOutput {
	...
	private function initFormatters() {
		...
		$formatter->setStyle ( 'strong', new OutputFormatterStyle ( null, null, array (
				'bold' 
		) ) );
		...
		// Visibility
		$formatter->setStyle ( 'public', new OutputFormatterStyle ( null, null, array (
				'bold' 
		) ) );
		$formatter->setStyle ( 'protected', new OutputFormatterStyle ( 'yellow' ) );
		$formatter->setStyle ( 'private', new OutputFormatterStyle ( 'red' ) );
		$formatter->setStyle ( 'global', new OutputFormatterStyle ( 'cyan', null, array (
				'bold' 
		) ) );
		$formatter->setStyle ( 'const', new OutputFormatterStyle ( 'cyan' ) );
		$formatter->setStyle ( 'class', new OutputFormatterStyle ( 'blue', null, array (
				'underscore' 
		) ) );
