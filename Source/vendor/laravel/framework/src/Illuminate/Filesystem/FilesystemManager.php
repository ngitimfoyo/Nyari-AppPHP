...
class FilesystemManager implements FactoryContract {
	...
	public function createS3Driver(array $config) {
		...
		return $this->adapt ( new Flysystem ( new S3Adapter ( new S3Client ( $config ), $config ['bucket'], $root ) ) );
	}
	...
	public function createRackspaceDriver(array $config) {
		...
		return $this->adapt ( new Flysystem ( new RackspaceAdapter ( $this->getRackspaceContainer ( $client, $config ) ) ) );
	}
