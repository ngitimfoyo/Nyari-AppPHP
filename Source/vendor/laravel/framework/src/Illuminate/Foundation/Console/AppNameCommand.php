...
class AppNameCommand extends Command {
	...
	protected function setComposerNamespace() {
		$this->replaceIn ( $this->getComposerPath (), $this->currentRoot . '\\\\', str_replace ( '\\', '\\\\', $this->argument ( 'name' ) ) . '\\\\' );
	}
	...
	protected function setAuthConfigNamespace() {
		$this->replaceIn ( $this->getAuthConfigPath (), $this->currentRoot . '\\User', $this->argument ( 'name' ) . '\\User' );
	}
	...
	protected function setServicesConfigNamespace() {
		$this->replaceIn ( $this->getServicesConfigPath (), $this->currentRoot . '\\User', $this->argument ( 'name' ) . '\\User' );
	}
