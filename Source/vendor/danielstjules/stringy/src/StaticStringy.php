...
class StaticStringy {
	 ...
	 *
	 * @param string $str
	 *        	String for which to return the chars
	 ...
	 *
	 * @param string $str
	 *        	String to convert to UpperCamelCase
	 * @param string $encoding
	 *        	The character encoding
	 ...
	 *
	 * @param string $str
	 *        	String to remove special chars
	 ...
	 *
	 * @param string $str
	 *        	The string to cleanup whitespace
	 * @param string $encoding
	 *        	The character encoding
	 ...
	 * A set of non-ASCII characters are
	...
	public static function pad($str, $length, $padStr = ' ', $padType = 'right', $encoding = null) {
		return ( string ) Stringy::create ( $str, $encoding )->pad ( $length, $padStr, $padType );
	}
	
	/**
	 * Returns a new string of a given length such that the beginning of the
	 * string is padded.
	 * Alias for pad() with a $padType of 'left'.
	 *
	 * @param string $str
	 *        	String to pad
	 * @param int $length
	 ...
	 * is padded.
	 * Alias for pad() with a $padType of 'right'.
	 *
	 * @param string $str
	 *        	String to pad
	 * @param int $length
	 ...
	 * string are padded.
	 * Alias for pad() with a $padType of 'both'.
	 *
	 * @param string $str
	 *        	String to pad
	 * @param int $length
	...
	/**
	 * Returns true if the string ends with $substring, false otherwise.
	 * By
	 * default, the comparison is case-sensitive, but can be made insensitive
	 * by setting $caseSensitive to false.
	 *
	 * @param string $str
	 *        	String to check the end of
	 * @param string $substring
	 *        	The substring to look for
	 * @param bool $caseSensitive
	 *        	Whether or not to enforce case-sensitivity
	 ...
	 *
	 * @param string $str
	 *        	String to convert tabs to spaces
	 * @param int $tabLength
	 ...
	 * defined by $tabLength, to a tab.
	 * By default, each 4 consecutive spaces
	 * are converted to a tab.
	 *
	 * @param string $str
	 *        	String to convert spaces to tabs
	 * @param int $tabLength
	 ...
	 * This includes replacing non-ASCII
	 ...
	 *
	 * @param string $str
	 *        	Text to transform into an URL slug
	...
	public static function containsAny($haystack, $needles, $caseSensitive = true, $encoding = null) {
		return Stringy::create ( $haystack, $encoding )->containsAny ( $needles, $caseSensitive );
	}
	...
	public static function containsAll($haystack, $needles, $caseSensitive = true, $encoding = null) {
		return Stringy::create ( $haystack, $encoding )->containsAll ( $needles, $caseSensitive );
	}
	
	/**
	 * Returns the index of the first occurrence of $needle in the string,
	 * and false if not found.
	 * Accepts an optional offset from which to begin
	 * the search.
	 *
	 * @param string $haystack
	 *        	String to search
	...
	public static function indexOf($haystack, $needle, $offset = 0, $encoding = null) {
		return Stringy::create ( $haystack, $encoding )->indexOf ( $needle, $offset );
	}
	 ...
	 */
	public static function indexOfLast($haystack, $needle, $offset = 0, $encoding = null) {
		return Stringy::create ( $haystack, $encoding )->indexOfLast ( $needle, $offset );
	}
	...
	public static function truncate($str, $length, $substring = '', $encoding = null) {
		return ( string ) Stringy::create ( $str, $encoding )->truncate ( $length, $substring );
	}
	
	/**
	 * Truncates the string to a given length, while ensuring that it does not
	 * split words.
	 * If $substring is provided, and truncating occurs, the
	...
	public static function safeTruncate($str, $length, $substring = '', $encoding = null) {
		return ( string ) Stringy::create ( $str, $encoding )->safeTruncate ( $length, $substring );
	}
	
	/**
	 * Returns a reversed string.
	 * A multibyte version of strrev().
	 *
	 * @param string $str
	 *        	String to reverse
	 * @param string $encoding
	...
	/**
	 * A multibyte str_shuffle() function.
	 * It returns a string with its
	...
	public static function longestCommonPrefix($str, $otherStr, $encoding = null) {
		return ( string ) Stringy::create ( $str, $encoding )->longestCommonPrefix ( $otherStr );
	}
	...
	public static function longestCommonSuffix($str, $otherStr, $encoding = null) {
		return ( string ) Stringy::create ( $str, $encoding )->longestCommonSuffix ( $otherStr );
	}
	...
	public static function longestCommonSubstring($str, $otherStr, $encoding = null) {
		return ( string ) Stringy::create ( $str, $encoding )->longestCommonSubstring ( $otherStr );
	}
	 ...
	 *
	 * @param string $str
	 *        	The string from which to get the char
	 * @param int $index
	 ...
	 * @param int $n
	 *        	Number of chars to retrieve from the start
	 * @param string $encoding
	 *        	The character encoding
	 ...
	 *        	The string from which to get the substring
	 * @param int $n
	 *        	Number of chars to retrieve from the end
	 * @param string $encoding
	 *        	The character encoding
	 ...
	 *
	 * @param string $str
	 *        	String from which to remove the suffix
	 * @param string $substring
	...
	public static function countSubstr($str, $substring, $caseSensitive = true, $encoding = null) {
		return Stringy::create ( $str, $encoding )->countSubstr ( $substring, $caseSensitive );
	}
