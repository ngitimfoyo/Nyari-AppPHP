...
class PHPUnit_TextUI_ResultPrinter extends PHPUnit_Util_Printer implements PHPUnit_Framework_TestListener {
	...
	public function printResult(PHPUnit_Framework_TestResult $result) {
		...
		if ($this->verbose) {
			...
			$printSeparator = $printSeparator || $result->riskyCount () > 0;
			...
			$printSeparator = $printSeparator || $result->notImplementedCount () > 0;
	...
	protected function printFooter(PHPUnit_Framework_TestResult $result) {
		...
		} elseif ($result->wasSuccessful () && $result->allHarmless () && $result->allCompletelyImplemented () && $result->noneSkipped ()) {
