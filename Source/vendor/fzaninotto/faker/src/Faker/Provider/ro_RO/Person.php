...
class Person extends \Faker\Provider\Person {
	 ...
	 *         
	 * @param string $gender
	 *        	Valid values: m, f, 1, 2
	 * @param integer $century
	 *        	Valid values: 1800, 1900, 2000, 1, 2, 3, 4, 5, 6
	 * @param string $county
	 *        	Valid values: 2 letter ISO 3166-2:RO county codes and B1-B6 for Bucharest's 6 sectors
	 * @return string
	 *
	 */
	public function cnp($gender = null, $century = null, $county = null) {
		...
		$cnp = ( string ) static::cnpFirstDigit ( $gender, $century ) . static::numerify ( '##' ) . sprintf ( '%02d', $this->generator->month () ) . sprintf ( '%02d', $this->generator->dayOfMonth () ) . $countyCode . static::numerify ( '##%' );
	...
	protected static function cnpFirstDigit($gender = null, $century = null) {
		switch ($century) {
			...
			case 6 :
				...
				break;
			default :
				$centuryCode = static::randomElement ( array (
						0,
						2,
						4,
						6,
		...
		switch (strtolower ( $gender )) {
			...
			case 2 :
				...
				break;
			default :
				$genderCode = static::randomElement ( array (
						1,
						2 
				) );
		}
