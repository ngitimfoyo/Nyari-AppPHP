...
class EmbedsMany extends EmbedsOneOrMany {
	...
	public function performUpdate(Model $model) {
		...
		$result = $this->getBaseQuery ()->where ( $this->localKey . '.' . $model->getKeyName (), $foreignKey )->update ( $values );
	...
	public function performDelete(Model $model) {
		...
		$result = $this->getBaseQuery ()->pull ( $this->localKey, [ 
				$model->getKeyName () => $foreignKey 
		] );
